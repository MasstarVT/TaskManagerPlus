...
/// Named "Security" here (rather than plain <see cref="EvidenceBundleService"/> below) because
/// it's a narrower, security-tab-scoped bundle of already-loaded session state, distinct from that
/// class's full evtx/WER/dump/systeminfo export.
/// </summary>

...
public static class DismService
{
    ...
    public static async Task<DismComponentStoreAnalysis> AnalyzeComponentStoreAsync(CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            return new DismComponentStoreAnalysis
            {
                Success = success,
        ...
        {
            return new DismComponentStoreAnalysis { Success = false, ErrorText = ex.Message };
        }
    }

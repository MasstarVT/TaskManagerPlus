...
/// ProxyOverride from the same per-user key - #574, domain 6's network-diagnostics work, arrived at
/// the identical field independently) - display only, this app never writes to these keys.</summary>

...
public static class MinifilterService
{
    ...
    /// <summary>Same concurrent-read/bounded-wait/kill-on-timeout shape PnpUtilService/
    /// KernelModuleService already establish - duplicated here rather than shared, matching how

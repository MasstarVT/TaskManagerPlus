...
/// Named "EventLog" here (rather than plain EvidenceBundleViewModel) since item #981-986's
/// EvidenceBundleViewModel already owns that name for the Troubleshoot tab's own, much broader
/// "collect everything" bundle - see EventLogEvidenceBundleService's own remarks for why the two
/// coexist rather than share one implementation.
/// </summary>
public sealed class EventLogEvidenceBundleViewModel : ObservableObject
{
    private readonly EventLogEvidenceBundleService _service = new();
    ...
    public EventLogEvidenceBundleViewModel()
    {

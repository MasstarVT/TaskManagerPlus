...
public sealed class MemoryViewModel : ObservableObject, IDisposable
{
    ...
    public ObservableCollection<PoolTagDriverRow> PoolTagRows { get; } = new();
    ...
    private PoolTagDriverSnapshot? _poolSnapshotBaseline;
    ...
    {
        _poolSnapshotBaseline = new PoolTagDriverSnapshot
        {
            CapturedAtUtc = DateTime.UtcNow,
            Tags = PoolTagRows.Select(r => new PoolTagDriverRow
            {
                Tag = r.Tag,

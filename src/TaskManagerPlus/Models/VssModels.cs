...
/// <summary>#398: one System Restore restore point, from WMI `SystemRestore` (root\default).
/// See VssService.ReadRestorePoints.</summary>
public sealed class RestorePointInfo
{
    public int SequenceNumber { get; set; }
    public DateTime? CreationTime { get; set; }
    public string Description { get; set; } = string.Empty;
    public string RestorePointTypeText { get; set; } = "Unknown";
}

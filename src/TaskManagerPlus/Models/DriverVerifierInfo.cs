...
/// Named "Config" here (rather than plain DriverVerifierStatus) since the Round-19/item-81
/// DriverVerifierStatus in DriverVerifierModels.cs already owns that name for the Stability tab's
/// own, differently-shaped `verifier /query` + `/querysettings` read - see
/// DriverVerifierControlService's summary for why the two coexist.
/// </summary>
public sealed class DriverVerifierConfigStatus
{

...
/// not a sampled heuristic (unlike #272's flag below). Named distinctly from item 64's
/// WaitChainModels.WaitChainResult (a separate, independently-built wait-chain feature) since both
/// exist side by side - see WaitChainTraversalService/ProcessesViewModel.AnalyzeWaitChainDetailedCommand.</summary>
public sealed class WaitChainTraversalResult
{

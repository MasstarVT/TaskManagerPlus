...
/// Named "DriverRow" (rather than plain PoolTagRow) since the Round-19/item-87 PoolTagRow in
/// DriverVerifierModels.cs already owns that name for the Stability tab's own, differently-shaped
/// pool-tag panel - both independently call NtQuerySystemInformation(SystemPoolTagInformation)
/// rather than share one implementation, since they were built for two different tabs.
/// </summary>
public sealed class PoolTagDriverRow
{
...
public sealed class PoolTagDriverSnapshot
{
    public DateTime CapturedAtUtc { get; set; }
    public List<PoolTagDriverRow> Tags { get; set; } = new();
}
